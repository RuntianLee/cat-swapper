...
test -f skills/mbti-origami-pet/SKILL.md
test -f skills/mbti-origami-pet/agents/openai.yaml
test -f skills/mbti-origami-pet/references/cocreation-flow.md
test -f skills/mbti-origami-pet/assets/origami-cat-dog-style-reference.png
test -f skills/mbti-origami-pet/assets/README.md
test -f skills/mbti-origami-pet/LICENSE
grep -Fq 'references/cocreation-flow.md' skills/mbti-origami-pet/SKILL.md
grep -Fq 'assets/origami-cat-dog-style-reference.png' skills/mbti-origami-pet/SKILL.md
grep -Fq 'mbti-origami-pet' README.md
grep -Fq 'mbti-origami-pet' README.zh-CN.md

style_reference_hash=$(sha256_file skills/mbti-origami-pet/assets/origami-cat-dog-style-reference.png)
test "$style_reference_hash" = "6d715339a663d7938e82e4c4633c43e2abdb198c1b8d592c5c8ba37dc276eda1"
grep -Fq "$style_reference_hash" skills/mbti-origami-pet/assets/README.md
...
echo "Skill files, prompt hashes, and style reference are valid."
